...
$agencyId = $_SESSION['reservation']['agence'];
...
<body>
<div class="navbar">
    <span><?php echo ucfirst($participantData["name"]); ?></span>
...
<h2>Sélection véhicule pour <?php echo ucfirst($participantData["name"]); ?></h2>
<ul>
    ...
    <div class="grid-container">
        <?php foreach ($vehicles as $vehicle): ?>
            ...
            <form action="/ECOMOBIL/index.php?action=SelectVehicleParticipant" method="POST" class="vehicle-selection-form">
                <input type="hidden" name="selectedVehicleId" value="<?php echo $vehicle['IdVehicule']; ?>">
                <input type="hidden" name="selectedVehicleLibelle" value="<?php echo $vehicle['Libelle']; ?>">
